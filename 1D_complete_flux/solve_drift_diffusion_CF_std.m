function [c] = solve_drift_diffusion_CF_std(Nx,D,mu,BC) 
%complete flux scheme, pcwise constant approximation of velocity field
...
%% coefficients associated with the inhomogeneous flux, pcwise constant approximation of V
Peclet = V_face/D*delta_x;
w_i_next = weight_function_IF_c(Peclet);
w_i_curr = weight_function_IF_c(-Peclet);
